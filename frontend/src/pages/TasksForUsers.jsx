...
function TasksForUsers() {
  ...
  return (
    ...
    <div className='flex justify-between mr-8 py-4 md:mr-16  mt-4'>
      ...
      {tasks.length===0&&statusValue==="Select a status"&&<div className='h-full w-full flex justify-center items-center text-gray-600 text-4xl font-bold'>There are no assigned tasks to you</div>}


      {tasks.length===0&&statusValue==="Not Started"&&<div className='h-full w-full flex justify-center items-center text-gray-600 text-4xl font-bold'>There are no assigned tasks that you have started</div>}

      {tasks.length===0&&statusValue==="In Progress"&&<div className='h-full w-full flex justify-center items-center text-gray-600 text-4xl font-bold'>There are no assigned tasks to you that are in progress</div>}
